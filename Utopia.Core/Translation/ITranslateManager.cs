...
public interface ITranslateManager : ISafeDictionary<Guuid, ITranslateProvider>
{
    ...
    bool TryGetTranslate(TranslateIdentifence language, Guuid? translateProviderId, string item, out string? result);
    ...
    bool Contains(TranslateIdentifence language, Guuid? translateProviderId, string item);
    ...
    /// Default language.
    /// </summary>
    TranslateIdentifence CurrentLanguage { get; set; }
}
