...
public class CsBuilder
{
    ...
    public void AddClass(string className, bool isPublic = false, bool isStatic = false,string from = "generated file",bool isPartial = false, params string[] parentClass)
    {
    ...
    public void CloseCodeBlock()
    {
        ...
        {
            throw new InvalidOperationException("has close all blocks");
        }
